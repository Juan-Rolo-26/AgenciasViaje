...
const destinos = [
    {
        ...
        imagenes: ["/assets/destinos/saopablo1.webp", "/assets/destinos/saopablo2.webp", "/assets/destinos/saopablo3.jpg"]
    },
    {
        orden: 84,
        ...
        imagenes: ["/assets/destinos/termas1.webp", "/assets/destinos/termas2.jpg", "/assets/destinos/termas3.jpg"]
    },
    {
        orden: 85,
        ...
        imagenes: ["/assets/destinos/arapey1.jpg", "/assets/destinos/arapey2.jpg", "/assets/destinos/arapey3.jpg"]
    },
    {
        orden: 86,
        ...
        imagenes: ["/assets/destinos/federacion1.jpg", "/assets/destinos/federacion2.jpg", "/assets/destinos/federacion3.jpg"]
    },
    {
        orden: 87,
        nombre: "Esquel",
        ...
        imagenes: ["/assets/destinos/esquel1.jpg", "/assets/destinos/esquel2.jpg", "/assets/destinos/esquel3.jpg"]
    },
    {
        orden: 88,
        nombre: "Natal",
        ...
        imagenes: ["/assets/destinos/natal1.jpg", "/assets/destinos/natal2.jpg", "/assets/destinos/natal3.jpg"]
    },
    {
        orden: 89,
        nombre: "Pipa",
        ...
        imagenes: ["/assets/destinos/pipa1.jpg", "/assets/destinos/pipa2.webp", "/assets/destinos/pipa3.jpg"]
    },
    {
        orden: 90,
        ...
        imagenes: ["/assets/destinos/capao1.webp", "/assets/destinos/capao2.webp", "/assets/destinos/capao3.jpg"]
    },
    {
        orden: 91,
        nombre: "Mendoza",
        ...
        imagenes: ["/assets/destinos/mendoza1.jpg", "/assets/destinos/mendoza2.jpg", "/assets/destinos/mendoza3.jpg"]
    },
    {
        orden: 92,
        nombre: "La Rioja",
        ...
        imagenes: ["/assets/destinos/larioja1.jpg", "/assets/destinos/larioja2.jpg", "/assets/destinos/larioja3.webp"]
    },
    {
        orden: 93,
        nombre: "Formosa",
        ...
        imagenes: ["/assets/destinos/formosa1.jpeg", "/assets/destinos/formosa2.jpg", "/assets/destinos/formosa3.jpg"]
    },
    {
        orden: 94,
        nombre: "Corrientes",
        ...
        imagenes: ["/assets/destinos/corrientes1.webp", "/assets/destinos/corrientes2.jpg", "/assets/destinos/corrientes3.jpg"]
    },
    {
        orden: 96,
        nombre: "Guatemala",
        ...
        imagenes: ["/assets/destinos/guatemala1.webp", "/assets/destinos/guatemala2.webp", "/assets/destinos/guatemala3.webp"]
    }
];
...
const cruceros = [
    {
        ...
        imagenes: ["/assets/destinos/crucero-lakonga1.webp", "/assets/destinos/crucero-lakonga2.webp", "/assets/destinos/crucero-lakonga3.webp"]
    }
];

async function main() {
    console.log("Iniciando carga de nuevos destinos y cruceros...");

    for (const d of destinos) {
        const descripcionCorta = d.descripcion.split(". ")[0] + ".";
        const record = await prisma.destino.upsert({
            where: { slug: d.slug },
            update: {
                nombre: d.nombre,
                paisRegion: d.paisRegion,
        ...
        await prisma.imagenDestino.createMany({
            data: d.imagenes.map((imagen, index) => ({
                destinoId: record.id,
                imagen,
                orden: index + 1
            }))
    ...
    for (const c of cruceros) {
        const record = await prisma.crucero.upsert({
            where: { slug: c.slug },
            update: {
                nombre: c.nombre,
        ...
        await prisma.imagenCrucero.deleteMany({ where: { cruceroId: record.id } });
        await prisma.imagenCrucero.createMany({
            data: c.imagenes.map((imagen, index) => ({
                cruceroId: record.id,
                imagen,
                orden: index + 1
            }))
        });
        console.log(`✓ Crucero: ${c.nombre}`);
    }
}
